...
---CC EXCLUSIVE: Checks if a hierarchy of keys exists in a given table.
---Returns that value if found, else returns the table which has been passed as the first argument.
---@param tbl table The table to be checked.
---@param ... string The values to be checked.
---@return table|any
function utils.areKeysInTable(tbl, ...)
    for _, v in pairs({ ... }) do
        tbl = tbl[v]
...
---Returns a value rounded up to the nearest multiple of another value.
---@param value number The value to be rounded.
---@param roundTo number The first number will be rounded up to a multiple of this value.
---@return number
function utils.roundUp(value, roundTo)
	return math.ceil(value / roundTo) * roundTo
end

---Returns a value rounded down to the nearest multiple of another value.
---@param value number The value to be rounded.
---@param roundTo number The first number will be rounded down to a multiple of this value.
---@return number
function utils.roundDown(value, roundTo)
